...
# def update():
#     if held_keys['a']:
#         test_squre.x -= 1*time.dt

# # from ursina.prefabs.slider import scale_box
# app = Ursina()

# test_squre = Entity(model = 'quad',color = color.red,scale =(1,4), position= (5,4))
...
# creating a button
btn = Test_button()
punch_sound = Audio('C:/krishnak/all python projects/minecraft/assets/punch_sound.wav', loop=False, autoplay=False)
